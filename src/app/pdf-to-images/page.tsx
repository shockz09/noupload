...
import { ImageIcon, DownloadIcon, LoaderIcon, PdfIcon } from "@/components/icons";
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 p-4 bg-card border-2 border-foreground">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground uppercase">{format} · {QUALITY_SETTINGS[quality].label}</p>
              </div>
            </div>
        ...
        <div className="max-w-md mx-auto border-2 border-foreground p-8 bg-card">
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">{selectedCount} pages · {format.toUpperCase()}</p>
            </div>
          ...
          {pagesLoading ? (
            ...
            <>
              ...
              <div className="flex items-center justify-between p-3 border-2 border-foreground/30 bg-muted/30">
                ...
                <div className="flex items-center gap-2">
                  <button onClick={selectAll} className="text-xs font-bold text-primary hover:underline">
                    All
                  </button>
                  <span className="text-muted-foreground">·</span>
                  <button onClick={selectNone} className="text-xs font-bold text-primary hover:underline">
                    None
                  </button>
                </div>
              </div>
                ...
                {showSettings && (
                  <div className="p-4 border-t-2 border-foreground space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <div className="w-1.5 h-4 bg-foreground" />
                        <label className="text-xs font-bold tracking-wider uppercase text-muted-foreground">Format</label>
                      </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <div className="w-1.5 h-4 bg-foreground" />
                        <label className="text-xs font-bold tracking-wider uppercase text-muted-foreground">Quality</label>
                      </div>
                      <div className="flex gap-2">
