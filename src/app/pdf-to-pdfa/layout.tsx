...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Convert PDF to PDF/A Free - Archive-Ready PDF Converter",
    description: "Convert PDF to PDF/A archive format for free. ISO compliant. Works 100% offline.",
  },
};

export default function PdfToPdfaLayout({ children }: { children: React.ReactNode }) {
  return children;
}
