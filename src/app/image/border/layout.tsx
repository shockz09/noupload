...
export const metadata: Metadata = {
  ...
  keywords: ["image border", "add border", "photo frame", "border generator", "picture frame", "free border tool"],
  openGraph: {
    title: "Add Border to Image Free - Photo Frame Generator",
    description: "Add borders and frames to images for free. Works 100% offline.",
  },
};
