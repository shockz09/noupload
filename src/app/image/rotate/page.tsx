        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-wide text-muted-foreground">Rotate</label>
              ...
              {rotation !== 0 && (
                <p className="text-xs text-center text-muted-foreground">Rotation: {rotation}°</p>
              )}
            </div>

            {/* Flip */}
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-wide text-muted-foreground">Flip</label>
              <div className="flex gap-2">
                <button
            ...
            {hasChanges && (
              <div className="flex items-center justify-between p-3 bg-muted/50 border border-foreground/10">
                <p className="text-xs text-muted-foreground">
                  Changes: {[rotation !== 0 && `${rotation}°`, flipH && "H-flip", flipV && "V-flip"].filter(Boolean).join(", ")}
                </p>
                <button
            ...
            >
              {isProcessing ? (
                ...
                <><RotateIcon className="w-5 h-5" />Apply Changes</>
              )}
            </button>
          </div>
        </div>
