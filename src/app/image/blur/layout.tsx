...
export const metadata: Metadata = {
  ...
  keywords: ["blur image", "add blur", "image blur effect", "gaussian blur", "blur photo", "free blur tool"],
  openGraph: {
    title: "Blur Image Free - Add Blur Effect Online",
    description: "Add blur effects to images for free. Works 100% offline.",
  },
};
