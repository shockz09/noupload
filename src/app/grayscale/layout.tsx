...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Convert PDF to Grayscale Free - Black and White PDF",
    description: "Convert color PDFs to grayscale for free. Perfect for printing. Works 100% offline.",
  },
};

export default function GrayscaleLayout({ children }: { children: React.ReactNode }) {
  return children;
}
