        ...
        <div className="relative inline-block">
          ...
          <div className="relative">
            ...
            <div className="relative bg-background border-2 border-foreground p-8 sm:p-12">
              ...
              <div className="absolute -top-[2px] left-4 right-4 h-3 bg-background border-x-2 border-t-2 border-foreground"
                   style={{ clipPath: 'polygon(0% 100%, 5% 40%, 10% 100%, 15% 60%, 20% 100%, 25% 30%, 30% 100%, 35% 50%, 40% 100%, 45% 40%, 50% 100%, 55% 60%, 60% 100%, 65% 30%, 70% 100%, 75% 50%, 80% 100%, 85% 40%, 90% 100%, 95% 60%, 100% 100%)' }} />
