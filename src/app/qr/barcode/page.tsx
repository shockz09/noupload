...
import { ArrowLeftIcon, CopyIcon, DownloadIcon, BarcodeIcon } from "@/components/icons";
...
const PlaceholderIcon = memo(function PlaceholderIcon() {
	return (
		<svg
			aria-hidden="true"
			className="w-32 h-20 mx-auto mb-4 opacity-20"
			viewBox="0 0 128 80"
			fill="currentColor"
		>
			...
			<div className="flex items-start gap-6">
				...
				<div>
					...
					<p className="text-muted-foreground mt-2">
						Create barcodes for products, inventory, and shipping
					</p>
				</div>
			</div>
					...
					<div className="info-box">
						...
						<div className="text-sm">
							...
							<p className="text-muted-foreground">
								<strong>EAN/UPC</strong> for retail products. <strong>Code 128</strong> for
								any text. <strong>ITF-14</strong> for shipping cartons.
							</p>
						</div>
					</div>
				</div>
