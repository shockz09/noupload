...
export const metadata: Metadata = {
  ...
  description: "Unlock password-protected PDF files. Remove encryption from your documents. Works 100% in your browser.",
  keywords: ["decrypt pdf", "unlock pdf", "remove pdf password", "pdf unlocker", "pdf password remover"],
  openGraph: {
