        ...
        <div className="border-t-2 border-foreground">
          ...
          <div className="p-4 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <label className="text-xs font-bold tracking-wider uppercase text-muted-foreground">Presets</label>
            </div>
          ...
          <div className="p-4 border-t-2 border-foreground/20 bg-muted/30">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-1.5 h-4 bg-foreground" />
              <label className="text-xs font-bold tracking-wider uppercase text-muted-foreground">Custom</label>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <label className="flex items-center gap-3 p-2 border-2 border-foreground/30 hover:border-foreground transition-colors cursor-pointer group/color">
                <input
                  type="color"
                  value={darkColor}
          ...
          <div className="p-4 border-t-2 border-foreground/20">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-1.5 h-4 bg-foreground" />
              <label className="text-xs font-bold tracking-wider uppercase text-muted-foreground">Logo</label>
            </div>
            <input
              ref={logoInputRef}
              type="file"
              ...
              <div className="flex items-center gap-4 p-3 border-2 border-dashed border-foreground/30 bg-muted/20">
                ...
                <div className="flex-1 min-w-0 space-y-2">
                  ...
                  <label className="flex items-center gap-2 cursor-pointer select-none">
                    <div className={`w-4 h-4 border-2 border-foreground flex items-center justify-center transition-colors ${logoPadding ? "bg-foreground" : "bg-transparent"}`}>
                      {logoPadding && (
