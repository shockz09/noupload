 ...
 * ```
 */
export function useClipboardPaste(onFilePasted: (files: File[]) => void, options: UseClipboardPasteOptions = {}) {
 ...
 */
export function useImagePaste(onImagePasted: (files: File[]) => void, enabled = true) {
