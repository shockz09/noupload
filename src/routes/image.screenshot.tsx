...
export const Route = createFileRoute("/image/screenshot")({
	head: () => ({
		meta: [
			{ title: "Screenshot to Image Free - Capture & Download Screenshots | noupload" },
			{ name: "description", content: "Capture screenshots for free. Download as PNG or JPG. Works offline, completely private." },
			{ name: "keywords", content: "screenshot tool, capture screenshot, screenshot to image, screen capture, free screenshot tool" },
			{ property: "og:title", content: "Screenshot to Image Free - Capture & Download" },
			{ property: "og:description", content: "Capture and download screenshots for free. Works 100% offline." },
		],
	}),
	component: ScreenshotBeautifierPage,
});

import { useCallback, useRef, useState } from "react";
import { CopyIcon, DownloadIcon, LoaderIcon } from "@/components/icons/ui";
import { ScreenshotIcon } from "@/components/icons/image";
...
function ScreenshotBeautifierPage() {
          ...
          <div className="border-2 border-foreground overflow-auto max-h-[500px]">
            ...
            >
              ...
              >
                ...
                <img src={image} alt="Screenshot" style={{ display: "block" }} loading="lazy" decoding="async" />
              </div>
            </div>
          </div>
