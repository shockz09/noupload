...
export const Route = createFileRoute("/pdf-to-pdfa")({
	head: () => ({
		meta: [
			{ title: "Convert PDF to PDF/A Free - Archive-Ready PDF Converter | noupload" },
			{ name: "description", content: "Convert PDF to PDF/A format for free. Create archive-ready, long-term preservation PDFs. ISO compliant. Works offline, completely private." },
			{ name: "keywords", content: "pdf to pdfa, pdfa converter, pdf archive format, convert to pdfa, pdf long term storage, iso pdf format, free pdfa converter" },
			{ property: "og:title", content: "Convert PDF to PDF/A Free - Archive-Ready PDF Converter" },
			{ property: "og:description", content: "Convert PDF to PDF/A archive format for free. ISO compliant. Works 100% offline." },
		],
	}),
      ...
      {result ? (
        ...
        <div className="space-y-6">
          ...
          <fieldset className="space-y-3">
            <legend className="text-sm font-medium text-foreground">PDF/A Conformance Level</legend>
