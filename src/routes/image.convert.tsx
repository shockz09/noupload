...
export const Route = createFileRoute("/image/convert")({
	head: () => ({
		meta: [
			{ title: "Convert Image Free - JPG PNG WebP SVG Converter | noupload" },
			{ name: "description", content: "Convert images between formats for free. JPG, PNG, WebP, SVG to raster, and more. Works offline, your files stay private." },
			{ name: "keywords", content: "convert image, image converter, jpg to png, png to jpg, webp converter, svg to png, free image converter" },
			{ property: "og:title", content: "Convert Image Free - JPG PNG WebP SVG Converter" },
			{ property: "og:description", content: "Convert images between formats for free. SVG to raster supported. Works 100% offline." },
		],
	}),
