...
export const Route = createFileRoute("/video/trim")({
	head: () => ({
		meta: [
			{ title: "Trim Video Free - Cut & Clip Video Online | noupload" },
			{ name: "description", content: "Trim video files for free. Cut and clip video segments. Works offline, completely private." },
			{ name: "keywords", content: "trim video, cut video, video trimmer, clip video, video cutter, free video trimmer" },
			{ property: "og:title", content: "Trim Video Free - Cut & Clip Video Online" },
			{ property: "og:description", content: "Trim and cut video files for free. Works 100% offline." },
		],
	}),
