...
export const Route = createFileRoute("/audio/volume")({
	head: () => ({
		meta: [
			{ title: "Adjust Audio Volume Free - Increase or Decrease Volume | noupload" },
			{ name: "description", content: "Adjust audio volume for free. Increase or decrease volume levels. Amplify or reduce sound. Works offline, completely private." },
			{ name: "keywords", content: "audio volume, adjust volume, increase volume, decrease volume, audio amplifier, free volume adjuster" },
			{ property: "og:title", content: "Adjust Audio Volume Free - Increase or Decrease Volume" },
			{ property: "og:description", content: "Adjust audio volume levels for free. Works 100% offline." },
		],
	}),
	component: VolumeAudioPage,
});
