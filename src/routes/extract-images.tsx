...
export const Route = createFileRoute("/extract-images")({
	head: () => ({
		meta: [
			{ title: "Extract Images from PDF Free - Download All Images | noupload" },
			{ name: "description", content: "Extract all images from PDF files for free. Download images in original quality as PNG or JPG. Works offline, your files stay private." },
			{ name: "keywords", content: "extract images from pdf, pdf to images, get images from pdf, pdf image extractor, download pdf images, free image extraction" },
			{ property: "og:title", content: "Extract Images from PDF Free - Download All Images" },
			{ property: "og:description", content: "Extract all images from PDF files for free. Download in original quality. Works 100% offline." },
		],
	}),
	component: ExtractImagesPage,
});

import { useCallback, useState } from "react";
import { DownloadIcon } from "@/components/icons/ui";
import { ExtractImageIcon } from "@/components/icons/image";
