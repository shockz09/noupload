...
export const Route = createFileRoute("/duplicate")({
	head: () => ({
		meta: [
			{ title: "Duplicate PDF Pages Free - Copy Pages Online | noupload" },
			{ name: "description", content: "Duplicate PDF pages for free. Select and copy pages to append to your document. Works 100% in your browser." },
			{ name: "keywords", content: "duplicate pdf pages, copy pdf pages, clone pdf pages, repeat pdf pages" },
			{ property: "og:title", content: "Duplicate PDF Pages Free" },
			{ property: "og:description", content: "Select and duplicate pages in your PDF. Works 100% offline." },
		],
	}),
