...
export const Route = createFileRoute("/watermark")({
	head: () => ({
		meta: [
			{ title: "Add Watermark to PDF Free - Text Watermark Online | noupload" },
			{ name: "description", content: "Add text watermark to PDF for free. Customize opacity, rotation, position, and font size. Drag to place anywhere. Works 100% in your browser." },
			{ name: "keywords", content: "add watermark pdf, pdf watermark, watermark pdf online, text watermark, pdf stamp" },
			{ property: "og:title", content: "Add Watermark to PDF Free" },
			{ property: "og:description", content: "Add customizable text watermarks to your PDF. Adjust opacity and rotation. Works 100% offline." },
		],
	}),
      ...
      {result ? (
        <div className="max-w-2xl mx-auto">
          <PdfResultView
            ...
            subtitle="Your watermarked PDF is ready"
            data={result.data}
