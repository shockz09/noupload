...
export const Route = createFileRoute("/image/")({
	head: () => ({
		meta: [
			{ title: "Free Online Image Tools - Compress, Resize, Convert Images | noupload" },
			{ name: "description", content: "Free image editing tools that work in your browser. Compress, resize, crop, convert, add filters and more. No uploads, your images stay private." },
			{ name: "keywords", content: "image editor, image compressor, resize image, convert image, image tools online, free image editor" },
			{ property: "og:title", content: "Free Online Image Tools - Compress, Resize, Convert Images" },
			{ property: "og:description", content: "Free image editing tools that work in your browser. No uploads, your images stay private." },
		],
	}),
...
import { imageCategoryLabels, imageTools } from "@/app/image-tools-grid";
function ImagesPage() {
  return (
