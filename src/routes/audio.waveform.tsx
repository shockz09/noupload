...
export const Route = createFileRoute("/audio/waveform")({
	head: () => ({
		meta: [
			{ title: "Audio Waveform Generator Free - Visualize Audio | noupload" },
			{ name: "description", content: "Generate audio waveform visualizations for free. Create waveform images from audio files. Works offline, your files stay private." },
			{ name: "keywords", content: "audio waveform, waveform generator, visualize audio, audio visualization, sound wave image, free waveform generator" },
			{ property: "og:title", content: "Audio Waveform Generator Free - Visualize Audio" },
			{ property: "og:description", content: "Generate audio waveform visualizations for free. Works 100% offline." },
		],
	}),
