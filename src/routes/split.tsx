...
export const Route = createFileRoute("/split")({
	head: () => ({
		meta: [
			{ title: "Split PDF Online Free - Extract Pages from PDF | noupload" },
			{ name: "description", content: "Split PDF into multiple files or extract specific pages for free. Select pages visually, download instantly. No uploads, works offline." },
			{ name: "keywords", content: "split pdf, extract pdf pages, pdf splitter, separate pdf, free pdf split, divide pdf" },
			{ property: "og:title", content: "Split PDF Online Free - Extract Pages from PDF" },
			{ property: "og:description", content: "Split PDF into multiple files or extract specific pages for free. Works 100% offline." },
		],
	}),
	component: SplitPage,
});
          ...
          {mode === "range" && (
            <div className="space-y-2">
              ...
              <input
                ...
                className="input-field"
              />
              <p className="text-xs text-muted-foreground">Each range will become a separate PDF file.</p>
            </div>
          )}
