...
export const Route = createFileRoute("/image/border")({
	head: () => ({
		meta: [
			{ title: "Add Border to Image Free - Photo Frame Generator | noupload" },
			{ name: "description", content: "Add borders to images for free. Choose color, width, and style. Create photo frames. Works offline, your files stay private." },
			{ name: "keywords", content: "image border, add border, photo frame, border generator, picture frame, free border tool" },
			{ property: "og:title", content: "Add Border to Image Free - Photo Frame Generator" },
			{ property: "og:description", content: "Add borders and frames to images for free. Works 100% offline." },
		],
	}),
	component: ImageBorderPage,
});
