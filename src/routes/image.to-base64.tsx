...
export const Route = createFileRoute("/image/to-base64")({
	head: () => ({
		meta: [
			{ title: "Image to Base64 Converter Free - Encode Images Online | noupload" },
			{ name: "description", content: "Convert images to Base64 for free. Encode JPG, PNG, WebP to Base64 string. Copy or download. Works offline, completely private." },
			{ name: "keywords", content: "image to base64, base64 encoder, convert image base64, base64 image, encode image, free base64 converter" },
			{ property: "og:title", content: "Image to Base64 Converter Free - Encode Images Online" },
			{ property: "og:description", content: "Convert images to Base64 encoding for free. Works 100% offline." },
		],
	}),
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-muted-foreground">{formatFileSize(base64.length)} characters</span>
                </div>
                <textarea value={base64} readOnly className="input-field w-full h-32 font-mono text-xs resize-none" />
              </div>
