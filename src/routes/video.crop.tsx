...
export const Route = createFileRoute("/video/crop")({
	head: () => ({
		meta: [
			{ title: "Crop Video Free - Cut & Trim Video Online | noupload" },
			{ name: "description", content: "Crop video for free. Adjust video boundaries and aspect ratio. Works offline, completely private." },
			{ name: "keywords", content: "crop video, cut video, video cropper, trim video frame, free video crop" },
			{ property: "og:title", content: "Crop Video Free - Cut & Trim Video Online" },
			{ property: "og:description", content: "Crop video for free. Works 100% offline." },
		],
	}),
	component: CropVideoPage,
});
