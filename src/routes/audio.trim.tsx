...
export const Route = createFileRoute("/audio/trim")({
	head: () => ({
		meta: [
			{ title: "Trim Audio Free - Cut & Clip Audio Online | noupload" },
			{ name: "description", content: "Trim audio files for free. Cut, clip, and extract portions of audio. Visual waveform editor. Works offline, your files stay private." },
			{ name: "keywords", content: "trim audio, cut audio, audio trimmer, clip audio, audio cutter, free audio trimmer" },
			{ property: "og:title", content: "Trim Audio Free - Cut & Clip Audio Online" },
			{ property: "og:description", content: "Trim and cut audio files for free. Works 100% offline." },
		],
	}),
	component: TrimAudioPage,
});
    ...
    <div className="page-enter max-w-2xl mx-auto space-y-8">
      ...
      {result ? (
        ...
        <div className="space-y-6">
          {audioUrl && <audio ref={audioRef} src={audioUrl} onTimeUpdate={handleTimeUpdate} onEnded={handleEnded} />}
