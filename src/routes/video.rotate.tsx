...
export const Route = createFileRoute("/video/rotate")({
	head: () => ({
		meta: [
			{ title: "Rotate Video Free - Flip & Rotate Videos Online | noupload" },
			{ name: "description", content: "Rotate video for free. Rotate 90, 180, 270 degrees or flip. Works offline, completely private." },
			{ name: "keywords", content: "rotate video, flip video, video rotator, turn video, free video rotate" },
			{ property: "og:title", content: "Rotate Video Free - Flip & Rotate Videos Online" },
			{ property: "og:description", content: "Rotate and flip videos for free. Works 100% offline." },
		],
	}),
