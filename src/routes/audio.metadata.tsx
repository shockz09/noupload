...
export const Route = createFileRoute("/audio/metadata")({
	head: () => ({
		meta: [
			{ title: "Audio Metadata Editor Free - View & Edit MP3 ID3 Tags | noupload" },
			{ name: "description", content: "View and edit audio metadata for free. Read existing ID3 tags, change title, artist, album, year, genre, and cover art. Strip all tags. Works offline, completely private." },
			{ name: "keywords", content: "audio metadata, view mp3 tags, read id3 tags, edit mp3 tags, id3 editor, id3 tag viewer, mp3 tag editor, audio tag editor, strip id3 tags, free metadata editor" },
			{ property: "og:title", content: "Audio Metadata Editor Free - View & Edit MP3 ID3 Tags" },
			{ property: "og:description", content: "View and edit audio metadata and ID3 tags for free. Read existing tags, edit, or strip them. Works 100% offline." },
		],
	}),
