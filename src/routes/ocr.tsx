...
export const Route = createFileRoute("/ocr")({
	head: () => ({
		meta: [
			{ title: "PDF OCR Online Free - Extract Text from Scanned PDF | noupload" },
			{ name: "description", content: "Extract text from scanned PDFs and images using OCR for free. Supports multiple languages. Works offline, your documents stay private." },
			{ name: "keywords", content: "pdf ocr, extract text from pdf, scanned pdf to text, ocr online, image to text, free ocr" },
			{ property: "og:title", content: "PDF OCR Online Free - Extract Text from Scanned PDF" },
			{ property: "og:description", content: "Extract text from scanned PDFs and images using OCR for free. Works 100% offline." },
		],
	}),
	component: OcrPage,
});
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">Make scanned PDFs searchable or extract text</p>
          </div>
        </div>
      </div>
            ...
            <div className="animate-fade-up max-w-2xl mx-auto">
              <div className="success-card">
                ...
                <div className="space-y-2 mb-8">
                  ...
                  <p className="text-muted-foreground">Text is now selectable and searchable in PDF viewers</p>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button type="button" onClick={handleDownloadSearchablePdf} className="btn-success flex-1">
