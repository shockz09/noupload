...
export const Route = createFileRoute("/audio/merge")({
	head: () => ({
		meta: [
			{ title: "Merge Audio Free - Combine Audio Files Online | noupload" },
			{ name: "description", content: "Merge multiple audio files for free. Combine MP3, WAV, and other formats. Reorder tracks. Works offline, completely private." },
			{ name: "keywords", content: "merge audio, combine audio, audio merger, join audio files, concatenate audio, free audio merger" },
			{ property: "og:title", content: "Merge Audio Free - Combine Audio Files Online" },
			{ property: "og:description", content: "Merge multiple audio files for free. Works 100% offline." },
		],
	}),
	component: MergeAudioPage,
});
        ...
        <div className="space-y-4">
          ...
          {files.length >= 2 && (
            <div className="border-2 border-foreground p-4 bg-card space-y-3">
              <span className="text-xs font-bold uppercase tracking-wide text-muted-foreground">Output Format</span>
