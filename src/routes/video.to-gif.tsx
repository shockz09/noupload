...
export const Route = createFileRoute("/video/to-gif")({
	head: () => ({
		meta: [
			{ title: "Video to GIF Free - Convert Video to Animated GIF | noupload" },
			{ name: "description", content: "Convert video to GIF for free. Create animated GIFs from video clips. Works offline, completely private." },
			{ name: "keywords", content: "video to gif, convert to gif, gif maker, animated gif, video gif converter, free gif maker" },
			{ property: "og:title", content: "Video to GIF Free - Convert Video to Animated GIF" },
			{ property: "og:description", content: "Convert video to animated GIF for free. Works 100% offline." },
		],
	}),
