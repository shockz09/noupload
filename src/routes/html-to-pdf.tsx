...
export const Route = createFileRoute("/html-to-pdf")({
	head: () => ({
		meta: [
			{ title: "HTML to PDF Converter Free - Convert Web Pages to PDF | noupload" },
			{ name: "description", content: "Convert HTML files to PDF for free. Transform web pages and HTML code into PDF documents. Preserves formatting. Works offline, completely private." },
			{ name: "keywords", content: "html to pdf, convert html to pdf, webpage to pdf, html pdf converter, web page to pdf, free html to pdf" },
			{ property: "og:title", content: "HTML to PDF Converter Free - Convert Web Pages to PDF" },
			{ property: "og:description", content: "Convert HTML files to PDF for free. Preserves formatting. Works 100% offline." },
		],
	}),
