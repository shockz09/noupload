...
export const Route = createFileRoute("/image/collage")({
	head: () => ({
		meta: [
			{ title: "Photo Collage Maker Free - Create Image Collages | noupload" },
			{ name: "description", content: "Create photo collages for free. Multiple layout options, customizable spacing. Combine multiple images. Works offline, completely private." },
			{ name: "keywords", content: "photo collage, collage maker, image collage, combine photos, collage generator, free collage maker" },
			{ property: "og:title", content: "Photo Collage Maker Free - Create Image Collages" },
			{ property: "og:description", content: "Create beautiful photo collages for free. Works 100% offline." },
		],
	}),
...
function CollagePage() {
  ...
  const isNarrowLayout = Boolean(result) || files.length === 0;
