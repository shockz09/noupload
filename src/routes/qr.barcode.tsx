...
export const Route = createFileRoute("/qr/barcode")({
	head: () => ({
		meta: [
			{ title: "Barcode Generator Free - Create Barcodes Online | noupload" },
			{ name: "description", content: "Generate barcodes for free. Create Code128, EAN, UPC, Code39 and more. Download as PNG or SVG. Works offline, completely private." },
			{ name: "keywords", content: "barcode generator, create barcode, barcode maker, code128 generator, ean barcode, free barcode generator" },
			{ property: "og:title", content: "Barcode Generator Free - Create Barcodes Online" },
			{ property: "og:description", content: "Generate barcodes in multiple formats for free. Works 100% offline." },
		],
	}),
