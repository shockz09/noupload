...
export const Route = createFileRoute("/qr/bulk")({
	head: () => ({
		meta: [
			{ title: "Bulk QR Code Generator Free - Create Multiple QR Codes | noupload" },
			{ name: "description", content: "Generate multiple QR codes at once for free. Bulk create QR codes from a list. Download as ZIP. Works offline, completely private." },
			{ name: "keywords", content: "bulk qr generator, multiple qr codes, batch qr code, qr code batch, mass qr generator, free bulk qr" },
			{ property: "og:title", content: "Bulk QR Code Generator Free - Create Multiple QR Codes" },
			{ property: "og:description", content: "Generate multiple QR codes at once for free. Works 100% offline." },
		],
	}),
	component: BulkQRGeneratePage,
});
