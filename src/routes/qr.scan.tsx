...
export const Route = createFileRoute("/qr/scan")({
	head: () => ({
		meta: [
			{ title: "QR Code Scanner Free - Scan QR Codes Online | noupload" },
			{ name: "description", content: "Scan QR codes for free using your camera or upload an image. Decode any QR code instantly. Works offline, your data stays private." },
			{ name: "keywords", content: "qr code scanner, scan qr code, qr reader, decode qr code, qr code decoder, free qr scanner" },
			{ property: "og:title", content: "QR Code Scanner Free - Scan QR Codes Online" },
			{ property: "og:description", content: "Scan QR codes with camera or image upload for free. Works 100% offline." },
		],
	}),
      ...
      {!scanResult ? (
        <div className="space-y-6">
          ...
          <div className="border-2 border-foreground bg-card overflow-hidden">
            <div ref={containerRef} className="relative bg-[#0A0A0A] overflow-hidden" style={{ minHeight: 340 }}>
              {!isScanning && (
                <div
            ...
            <div className="p-4 border-t-2 border-foreground bg-card">
              <div className="flex gap-3">
                ...
                >
                  {isProcessingFile ? <LoaderIcon className="w-5 h-5" /> : <UploadIcon className="w-5 h-5" />}
        ...
        <div className="space-y-6 animate-fade-up">
          ...
          <button type="button" onClick={handleScanAnother} className="btn-secondary w-full">
            <ScanIcon className="w-5 h-5" />
            Scan Another Code
          </button>
        </div>
