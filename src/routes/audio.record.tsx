...
export const Route = createFileRoute("/audio/record")({
	head: () => ({
		meta: [
			{ title: "Record Audio Free - Online Voice Recorder | noupload" },
			{ name: "description", content: "Record audio from your microphone for free. Online voice recorder with download. No installation needed. Works in browser, completely private." },
			{ name: "keywords", content: "record audio, voice recorder, online recorder, microphone recorder, audio recording, free voice recorder" },
			{ property: "og:title", content: "Record Audio Free - Online Voice Recorder" },
			{ property: "og:description", content: "Record audio from your microphone for free. Works in your browser." },
		],
	}),
