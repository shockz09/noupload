...
export const Route = createFileRoute("/images-to-pdf")({
	head: () => ({
		meta: [
			{ title: "Image to PDF Converter Free - Convert JPG/PNG to PDF | noupload" },
			{ name: "description", content: "Convert images to PDF for free. Combine multiple photos into one PDF, reorder and rotate. Works offline in your browser." },
			{ name: "keywords", content: "image to pdf, jpg to pdf, png to pdf, convert image to pdf, photo to pdf, pictures to pdf" },
			{ property: "og:title", content: "Image to PDF Converter Free - Convert JPG/PNG to PDF" },
			{ property: "og:description", content: "Convert images to PDF for free. Combine multiple photos into one PDF. Works 100% offline." },
		],
	}),
