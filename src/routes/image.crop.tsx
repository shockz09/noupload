...
export const Route = createFileRoute("/image/crop")({
	head: () => ({
		meta: [
			{ title: "Crop Image Free - Cut & Trim Images Online | noupload" },
			{ name: "description", content: "Crop images for free. Cut, trim, and adjust image boundaries. Use preset ratios or custom dimensions. Works offline, completely private." },
			{ name: "keywords", content: "crop image, cut image, trim image, image cropper, photo cropper, free image crop" },
			{ property: "og:title", content: "Crop Image Free - Cut & Trim Images Online" },
			{ property: "og:description", content: "Crop images for free. Cut and trim with precision. Works 100% offline." },
		],
	}),
