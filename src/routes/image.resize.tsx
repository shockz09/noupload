...
export const Route = createFileRoute("/image/resize")({
	head: () => ({
		meta: [
			{ title: "Resize Image Free - Change Image Dimensions Online | noupload" },
			{ name: "description", content: "Resize images for free. Change width, height, or scale by percentage. Maintain aspect ratio. Works offline, your files stay private." },
			{ name: "keywords", content: "resize image, change image size, image resizer, scale image, reduce image dimensions, free image resize" },
			{ property: "og:title", content: "Resize Image Free - Change Image Dimensions Online" },
			{ property: "og:description", content: "Resize images for free. Change dimensions easily. Works 100% offline." },
		],
	}),
