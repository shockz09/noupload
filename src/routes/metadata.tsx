...
export const Route = createFileRoute("/metadata")({
	head: () => ({
		meta: [
			{ title: "PDF Metadata Editor & Sanitizer Free - View, Edit & Strip PDF Properties | noupload" },
			{ name: "description", content: "View, edit, or strip PDF metadata for free. Change title, author, subject, keywords, or remove all metadata for privacy. Works offline, your files stay private." },
			{ name: "keywords", content: "pdf metadata, edit pdf properties, pdf metadata editor, change pdf title, pdf author editor, view pdf metadata, free metadata editor, sanitize pdf, strip pdf metadata, remove pdf metadata, pdf privacy, clean pdf" },
			{ property: "og:title", content: "PDF Metadata Editor & Sanitizer Free - View, Edit & Strip Properties" },
			{ property: "og:description", content: "View, edit, or strip PDF metadata for free. Change title, author, and more — or remove all metadata for privacy. Works 100% offline." },
		],
	}),
