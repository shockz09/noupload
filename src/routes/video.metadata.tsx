...
export const Route = createFileRoute("/video/metadata")({
	head: () => ({
		meta: [
			{ title: "Video Metadata Viewer Free - View Video Properties | noupload" },
			{ name: "description", content: "View video metadata for free. See codec, resolution, bitrate, duration, and more. Works offline, completely private." },
			{ name: "keywords", content: "video metadata, video properties, video info, video codec, video details, free metadata viewer" },
			{ property: "og:title", content: "Video Metadata Viewer Free - View Video Properties" },
			{ property: "og:description", content: "View video metadata and properties for free. Works 100% offline." },
		],
	}),
	component: VideoMetadataPage,
});
